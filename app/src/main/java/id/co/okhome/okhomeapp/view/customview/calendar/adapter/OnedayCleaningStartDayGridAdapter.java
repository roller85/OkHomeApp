...
public class OnedayCleaningStartDayGridAdapter extends ParentDayGridAdapter {


    public OnedayCleaningStartDayGridAdapter(Context context, List<DayModel> listDayModel, int itemHeight, MonthViewListener monthViewListener) {
