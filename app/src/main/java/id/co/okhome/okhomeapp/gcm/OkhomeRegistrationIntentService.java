...
public class OkhomeRegistrationIntentService extends IntentService {

    private static final String TAG = "OkhomeRegistrationIntentService";

    public OkhomeRegistrationIntentService() {
        super(TAG);
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        LocalBroadcastManager.getInstance(this)
                .sendBroadcast(new Intent(OkhomeGcmController.REGISTRATION_GENERATING));
        ...
        Intent registrationComplete = new Intent(OkhomeGcmController.REGISTRATION_COMPLETE);
